...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.description_html'
        db.add_column('djobs_job', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Job.description_html'
        db.delete_column('djobs_job', 'description_html')
