...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.profile_html'
        db.add_column('djobs_employer', 'profile_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Employer.profile_html'
        db.delete_column('djobs_employer', 'profile_html')
    ...
    models = {
        ...
        'djobs.employer': {
            ...
            'profile_html': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
